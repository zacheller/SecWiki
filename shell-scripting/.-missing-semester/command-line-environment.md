...
You can learn more about these and other signals \[here\]\([https://en.wikipedia.org/wiki/Signal\_\(IPC](https://en.wikipedia.org/wiki/Signal_%28IPC)\)\) or typing [`man signal`](https://www.man7.org/linux/man-pages/man7/signal.7.html) or `kill -t`.
