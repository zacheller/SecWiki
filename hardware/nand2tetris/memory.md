...
![Little triangle means chip is dependent on time, sequential, has state](../../.gitbook/assets/image%20%2861%29.png)
...
![16 bit register can be built from multiple 1-bit registers](../../.gitbook/assets/image%20%2847%29.png)
